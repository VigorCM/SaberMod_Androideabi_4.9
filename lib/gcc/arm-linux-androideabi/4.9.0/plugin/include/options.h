...
enum opt_code
{
  ...
  OPT_msingle_pic_base = 1071,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1072, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1073,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1074,                         /* -mthumb */
  OPT_mthumb_interwork = 1075,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1076,                  /* -mtls-dialect= */
  OPT_mtp_ = 1077,                           /* -mtp= */
  OPT_mtpcs_frame = 1078,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1079,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1080,                         /* -mtune= */
  OPT_muclibc = 1081,                        /* -muclibc */
  OPT_munaligned_access = 1082,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1083,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1084,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1085,              /* -mword-relocations */
  OPT_mwords_little_endian = 1086,           /* -mwords-little-endian */
  OPT_n = 1087,                              /* -n */
  ...
  OPT_o = 1096,                              /* -o */
  OPT_p = 1097,                              /* -p */
  OPT_pass_exit_codes = 1098,                /* -pass-exit-codes */
  /* OPT_pedantic = 1099, */                 /* -pedantic */
  OPT_pedantic_errors = 1100,                /* -pedantic-errors */
  OPT_pg = 1101,                             /* -pg */
  OPT_pie = 1102,                            /* -pie */
  OPT_pipe = 1103,                           /* -pipe */
  OPT_posix = 1104,                          /* -posix */
  OPT_print_file_name_ = 1105,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1106,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1107,          /* -print-multi-directory */
  OPT_print_multi_lib = 1108,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1109,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1110,                /* -print-multiarch */
  ...
  OPT_static_libasan = 1131,                 /* -static-libasan */
  OPT_static_libgcc = 1132,                  /* -static-libgcc */
  OPT_static_libgcj = 1133,                  /* -static-libgcj */
  OPT_static_libgfortran = 1134,             /* -static-libgfortran */
  OPT_static_libgo = 1135,                   /* -static-libgo */
